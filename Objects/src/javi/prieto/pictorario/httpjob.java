...
public boolean _vvvvvvvv3 = false;
public String _vvvvvvvv4 = "";
public String _vvvvvvvv5 = "";
public String _vvvvvvvv6 = "";
public Object _vvvvvvvv7 = null;
public String _vvvvvvvv0 = "";
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest _vvvvvvvvv1 = null;
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpResponse _vvvvvvvvv2 = null;
public Object _vvvvvvvvv3 = null;
...
_vvvvvvvv0 = BA.NumberToString(_id);
 //BA.debugLineNum = 250;BA.debugLine="CallSubDelayed2(target, \"JobDone\", Me)";
__c.CallSubDelayed2(ba,_vvvvvvvv7,"JobDone",this);
 //BA.debugLineNum = 251;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv3(String _link) throws Exception{
...
_vvvvvvvvv1.InitializeDelete(_link);
 //BA.debugLineNum = 208;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
...
_vvvvvvvvv1.InitializeDelete(_vvvvv7(_link,_parameters));
 //BA.debugLineNum = 213;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 214;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv5(String _link) throws Exception{
...
_vvvvvvvvv1.InitializeGet(_link);
 //BA.debugLineNum = 178;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 179;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv6(String _link,String[] _parameters) throws Exception{
...
_vvvvvvvvv1.InitializeGet(_vvvvv7(_link,_parameters));
 //BA.debugLineNum = 188;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 189;BA.debugLine="End Sub";
return "";
}
public String  _vvvvv7(String _link,String[] _parameters) throws Exception{
...
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvv0() throws Exception{
...
_b = __c.LoadBitmap(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0);
 //BA.debugLineNum = 266;BA.debugLine="Return b";
if (true) return _b;
 //BA.debugLineNum = 267;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvv1(int _width,int _height,boolean _keepaspectratio) throws Exception{
...
if (true) return __c.LoadBitmapResize(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0,_width,_height,_keepaspectratio);
 //BA.debugLineNum = 276;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.drawable.CanvasWrapper.BitmapWrapper  _vvvvvv2(int _width,int _height) throws Exception{
...
if (true) return __c.LoadBitmapSample(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0,_width,_height);
 //BA.debugLineNum = 272;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4a.objects.streams.File.InputStreamWrapper  _vvvvvv3() throws Exception{
...
_in = __c.File.OpenInput(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0);
 //BA.debugLineNum = 283;BA.debugLine="Return In";
if (true) return _in;
 //BA.debugLineNum = 284;BA.debugLine="End Sub";
return null;
}
public anywheresoftware.b4h.okhttp.OkHttpClientWrapper.OkHttpRequest  _vvvvvv4() throws Exception{
...
if (true) return _vvvvvv6("UTF8");
 //BA.debugLineNum = 226;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvv6(String _encoding) throws Exception{
...
_tr.Initialize2((java.io.InputStream)(__c.File.OpenInput(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0).getObject()),_encoding);
...
_vvvvvvvv7 = _targetmodule;
 //BA.debugLineNum = 38;BA.debugLine="End Sub";
return "";
}
public boolean  _vvvvvv0(anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper _stream,boolean _empty) throws Exception{
...
public String  _vvvvvvv1(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv1.InitializePatch2(_link,_data);
 //BA.debugLineNum = 78;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 79;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv2(String _link,String _text) throws Exception{
...
_vvvvvvv1(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 64;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv3(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv1.InitializePost2(_link,_data);
 //BA.debugLineNum = 47;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 48;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv4(String _link,String _dir,String _filename) throws Exception{
int _length = 0;
anywheresoftware.b4a.objects.streams.File.InputStreamWrapper _in = null;
...
_vvvvvvv3(_link,_out.ToBytesArray());
 }else {
 //BA.debugLineNum = 169;BA.debugLine="req.InitializePost(Link, In, length)";
_vvvvvvvvv1.InitializePost(_link,(java.io.InputStream)(_in.getObject()),_length);
...
public String  _vvvvvvv5(String _link,anywheresoftware.b4a.objects.collections.Map _namevalues,anywheresoftware.b4a.objects.collections.List _files) throws Exception{
String _boundary = "";
...
_empty = _vvvvvv0(_stream,_empty);
...
_vvvvvvv3(_link,_stream.ToBytesArray());
 //BA.debugLineNum = 133;BA.debugLine="req.SetContentType(\"multipart/form-data; boundary";
_vvvvvvvvv1.SetContentType("multipart/form-data; boundary="+_boundary);
 //BA.debugLineNum = 134;BA.debugLine="req.SetContentEncoding(\"UTF8\")";
_vvvvvvvvv1.SetContentEncoding("UTF8");
 //BA.debugLineNum = 135;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv6(String _link,String _text) throws Exception{
...
_vvvvvvv3(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 42;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv7(String _link,byte[] _data) throws Exception{
...
_vvvvvvvvv1.InitializePut2(_link,_data);
 //BA.debugLineNum = 58;BA.debugLine="CallSubDelayed2(HttpUtils2Service, \"SubmitJob\", M";
__c.CallSubDelayed2(ba,(Object)(_vvvvvvvvvv7.getObject()),"SubmitJob",this);
 //BA.debugLineNum = 59;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvv0(String _link,String _text) throws Exception{
...
_vvvvvvv7(_link,_text.getBytes("UTF8"));
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public String  _vvvvvvvv1() throws Exception{
...
__c.File.Delete(_vvvvvvvvvv7._vvvvv2 /*String*/ ,_vvvvvvvv0);
