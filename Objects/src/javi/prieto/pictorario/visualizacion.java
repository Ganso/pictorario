...
_actividadpulsada = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][(int)(BA.ObjectToNumber(_botonpulsado.getTag()))];
 //BA.debugLineNum = 296;BA.debugLine="ImagenPictograma.Bitmap=LoadBitmap(File.DirAssets";
mostCurrent._imagenpictograma.setBitmap((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][(int)(BA.ObjectToNumber(_botonpulsado.getTag()))].Pictograma+".png").getObject()));
...
mostCurrent._descripcionpictograma.setText(BA.ObjectToCharSequence("De "+BA.NumberToString(_vvvvvvv7(_actividadpulsada.hora_inicio))+_vvvvvvv0(_actividadpulsada.minuto_inicio)+" a "+BA.NumberToString(_vvvvvvv7(_actividadpulsada.hora_fin))+_vvvvvvv0(_actividadpulsada.minuto_fin)));
 //BA.debugLineNum = 299;BA.debugLine="FondoPictograma.Color=Starter.Colores(BotonPulsad";
mostCurrent._fondopictograma.setColor(mostCurrent._vvv2._vv3[(int)(BA.ObjectToNumber(_botonpulsado.getTag()))]);
...
mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo = (int) (((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo)+1)%4);
...
public static String  _vvvvvvvv1(int _numactividad) throws Exception{
int _horainicio = 0;
int _mininicio = 0;
int _horafin = 0;
int _minfin = 0;
...
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo>1 || (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==1 && mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].hora_fin>11) || (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==0 && mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].hora_inicio<12))) { 
 //BA.debugLineNum = 174;BA.debugLine="Dim HoraInicio=Starter.ActividadSecuencia(Starte";
_horainicio = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].hora_inicio;
 //BA.debugLineNum = 175;BA.debugLine="Dim MinInicio=Starter.ActividadSecuencia(Starter";
_mininicio = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].minuto_inicio;
 //BA.debugLineNum = 176;BA.debugLine="Dim HoraFin=Starter.ActividadSecuencia(Starter.S";
_horafin = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].hora_fin;
 //BA.debugLineNum = 177;BA.debugLine="Dim MinFin=Starter.ActividadSecuencia(Starter.Se";
_minfin = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].minuto_fin;
 //BA.debugLineNum = 178;BA.debugLine="If (Starter.Secuencia(Starter.SecuenciaActiva).t";
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==0 && _horafin>11)) { 
 //BA.debugLineNum = 179;BA.debugLine="HoraFin=12";
_horafin = (int) (12);
 //BA.debugLineNum = 180;BA.debugLine="MinFin=0";
_minfin = (int) (0);
 }else if((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==1 && _horainicio<12)) { 
...
_recorte.Initialize(_vvvvvvvv2,_vvvvvvvv3);
...
_recorte.LineTo(_vvvvvvvv2,_vvvvvvvv3);
...
mostCurrent._vvvvvvvv4.DrawCircle(_vvvvvvvv2,_vvvvvvvv3,(float) (_vvvvvvvv5*0.7),mostCurrent._vvv2._vv3[_numactividad],anywheresoftware.b4a.keywords.Common.True,(float) (0));
...
mostCurrent._vvvvvvvv7[_numactividad].Initialize(mostCurrent.activityBA,"BotonActividad");
 //BA.debugLineNum = 231;BA.debugLine="Boton(NumActividad).Tag=NumActividad";
mostCurrent._vvvvvvvv7[_numactividad].setTag((Object)(_numactividad));
...
_tamañoicono = (float) (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tam_icono*anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (1),mostCurrent.activityBA));
...
mostCurrent._activity.AddView((android.view.View)(mostCurrent._vvvvvvvv7[_numactividad].getObject()),(int) (_botonx),(int) (_botony),(int) (_tamañoicono),(int) (_tamañoicono));
 //BA.debugLineNum = 240;BA.debugLine="Boton(NumActividad).SetBackgroundImage(LoadBitma";
mostCurrent._vvvvvvvv7[_numactividad].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][_numactividad].Pictograma+".png").getObject()));
 };
...
_vvvvvvvv2 = (float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (50),mostCurrent.activityBA));
 //BA.debugLineNum = 46;BA.debugLine="CentroY=60%x";
_vvvvvvvv3 = (float) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (60),mostCurrent.activityBA));
...
if (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo<2) { 
 //BA.debugLineNum = 53;BA.debugLine="MinHora=1";
_vvvvvvvv0 = (int) (1);
 //BA.debugLineNum = 54;BA.debugLine="MaxHora=12";
_vvvvvvvvv1 = (int) (12);
 }else if(mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==2) { 
...
_vvvvvvvv0 = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][(int) (0)].hora_inicio;
 //BA.debugLineNum = 61;BA.debugLine="MaxHora=Starter.ActividadSecuencia(Starter.Secue";
_vvvvvvvvv1 = mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][(int) (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].num_actividades-1)].hora_fin;
 //BA.debugLineNum = 62;BA.debugLine="If (Starter.ActividadSecuencia(Starter.Secuencia";
if ((mostCurrent._vvv2._vv7[mostCurrent._vvv2._vv5][(int) (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].num_actividades-1)].minuto_fin!=0)) { 
 //BA.debugLineNum = 63;BA.debugLine="MaxHora=MaxHora+1";
_vvvvvvvvv1 = (int) (_vvvvvvvvv1+1);
 };
 };
 //BA.debugLineNum = 68;BA.debugLine="If Starter.Secuencia(Starter.SecuenciaActiva).tab";
if (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo<3) { 
 //BA.debugLineNum = 70;BA.debugLine="Pantalla.DrawCircle(CentroX,CentroY,Radio*1.05,C";
mostCurrent._vvvvvvvv4.DrawCircle(_vvvvvvvv2,_vvvvvvvv3,(float) (_vvvvvvvv5*1.05),anywheresoftware.b4a.keywords.Common.Colors.Gray,anywheresoftware.b4a.keywords.Common.True,(float) (0));
 //BA.debugLineNum = 71;BA.debugLine="Pantalla.DrawCircle(CentroX,CentroY,Radio,Colors";
mostCurrent._vvvvvvvv4.DrawCircle(_vvvvvvvv2,_vvvvvvvv3,_vvvvvvvv5,anywheresoftware.b4a.keywords.Common.Colors.White,anywheresoftware.b4a.keywords.Common.True,(float) (0));
 }else {
...
_recorte.Initialize(_vvvvvvvv2,(float) (_vvvvvvvv3+anywheresoftware.b4a.keywords.Common.PerYToCurrent((float) (3),mostCurrent.activityBA)));
 //BA.debugLineNum = 76;BA.debugLine="Recorte.LineTo( (CosD(114)*Radio*3)+CentroX, (Si";
_recorte.LineTo((float) ((anywheresoftware.b4a.keywords.Common.CosD(114)*_vvvvvvvv5*3)+_vvvvvvvv2),(float) ((anywheresoftware.b4a.keywords.Common.SinD(114)*_vvvvvvvv5*3)+_vvvvvvvv3));
...
_recorte.LineTo((float) ((anywheresoftware.b4a.keywords.Common.CosD(81)*_vvvvvvvv5*3)+_vvvvvvvv2),(float) ((anywheresoftware.b4a.keywords.Common.SinD(81)*_vvvvvvvv5)+_vvvvvvvv3));
...
_recorte.LineTo((float) ((anywheresoftware.b4a.keywords.Common.CosD(116)*_vvvvvvvv5*3)+_vvvvvvvv2),(float) ((anywheresoftware.b4a.keywords.Common.SinD(116)*_vvvvvvvv5*3)+_vvvvvvvv3));
...
_recorte.LineTo((float) ((anywheresoftware.b4a.keywords.Common.CosD(80)*_vvvvvvvv5*3)+_vvvvvvvv2),(float) ((anywheresoftware.b4a.keywords.Common.SinD(80)*_vvvvvvvv5)+_vvvvvvvv3));
...
if (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==1) { 
 //BA.debugLineNum = 116;BA.debugLine="MinHora=MinHora+12";
_vvvvvvvv0 = (int) (_vvvvvvvv0+12);
 //BA.debugLineNum = 117;BA.debugLine="MaxHora=MaxHora+12";
_vvvvvvvvv1 = (int) (_vvvvvvvvv1+12);
 };
 //BA.debugLineNum = 121;BA.debugLine="For NActividad=0 To Starter.Secuencia(Starter.Sec";
{
final int step62 = (int) (1);
final int limit62 = (int) (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].num_actividades-1);
_nactividad = (int) (0) ;
...
_vvvvvvvv1(_nactividad);
 }
};
 //BA.debugLineNum = 126;BA.debugLine="For NActividad=0 To Starter.Secuencia(Starter.Sec";
{
final int step65 = (int) (1);
final int limit65 = (int) (mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].num_actividades-1);
_nactividad = (int) (0) ;
...
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.indicar_hora>0 && _horaactual>=_vvvvvvvv0 && _horaactual<_vvvvvvvvv1)) { 
 //BA.debugLineNum = 135;BA.debugLine="If (Starter.Secuencia(Starter.SecuenciaActiva).t";
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo==3 || mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.indicar_hora==1)) { 
 //BA.debugLineNum = 136;BA.debugLine="Pantalla.DrawLine(CentroX,CentroY,HoraMinuto_X(";
mostCurrent._vvvvvvvv4.DrawLine(_vvvvvvvv2,_vvvvvvvv3,_horaminuto_x((float) (_horaactual),(float) (_minutoactual),(float) (0.8)),_horaminuto_y((float) (_horaactual),(float) (_minutoactual),(float) (0.8)),anywheresoftware.b4a.keywords.Common.Colors.Red,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8))));
 }else {
 //BA.debugLineNum = 138;BA.debugLine="Pantalla.DrawLine(CentroX,CentroY,HoraMinuto_X(";
mostCurrent._vvvvvvvv4.DrawLine(_vvvvvvvv2,_vvvvvvvv3,_horaminuto_x((float) (_horaactual),(float) (_minutoactual),(float) (0.6)),_horaminuto_y((float) (_horaactual),(float) (_minutoactual),(float) (0.6)),anywheresoftware.b4a.keywords.Common.Colors.DarkGray,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (8))));
 //BA.debugLineNum = 139;BA.debugLine="If (Starter.Secuencia(Starter.SecuenciaActiva).";
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.indicar_hora>1)) { 
...
mostCurrent._vvvvvvvv4.DrawLine(_vvvvvvvv2,_vvvvvvvv3,(float) (_vvvvvvvv2+anywheresoftware.b4a.keywords.Common.CosD(_angulominuto)*_vvvvvvvv5*0.8),(float) (_vvvvvvvv3+anywheresoftware.b4a.keywords.Common.SinD(_angulominuto)*_vvvvvvvv5*0.75),anywheresoftware.b4a.keywords.Common.Colors.DarkGray,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (6))));
 //BA.debugLineNum = 142;BA.debugLine="If (Starter.Secuencia(Starter.SecuenciaActiva)";
if ((mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.indicar_hora>2)) { 
...
mostCurrent._vvvvvvvv4.DrawLine(_vvvvvvvv2,_vvvvvvvv3,(float) (_vvvvvvvv2+anywheresoftware.b4a.keywords.Common.CosD(_angulosegundo)*_vvvvvvvv5*0.9),(float) (_vvvvvvvv3+anywheresoftware.b4a.keywords.Common.SinD(_angulosegundo)*_vvvvvvvv5*0.9),anywheresoftware.b4a.keywords.Common.Colors.Red,(float) (anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (4))));
 };
 };
 };
 };
 //BA.debugLineNum = 151;BA.debugLine="Pantalla.DrawCircle(CentroX,CentroY,Radio*0.1,Col";
mostCurrent._vvvvvvvv4.DrawCircle(_vvvvvvvv2,_vvvvvvvv3,(float) (_vvvvvvvv5*0.1),anywheresoftware.b4a.keywords.Common.Colors.Black,anywheresoftware.b4a.keywords.Common.True,(float) (0));
 //BA.debugLineNum = 155;BA.debugLine="Select Starter.Secuencia(Starter.SecuenciaActiva)";
switch (BA.switchObjectToInt(mostCurrent._vvv2._vv6[mostCurrent._vvv2._vv5].tablero.tipo,(int) (0),(int) (1),(int) (2),(int) (3))) {
case 0: {
...
mostCurrent._vvvvvvvv7 = new anywheresoftware.b4a.objects.ButtonWrapper[mostCurrent._vvv2._v7];
{
int d0 = mostCurrent._vvvvvvvv7.length;
for (int i0 = 0;i0 < d0;i0++) {
mostCurrent._vvvvvvvv7[i0] = new anywheresoftware.b4a.objects.ButtonWrapper();
}
}
;
...
public static int  _vvvvvvv7(int _hora24) throws Exception{
...
_angulo = (float) (120+(_hora+_minuto/(double)60-_vvvvvvvv0)*300/(double)(_vvvvvvvvv1-_vvvvvvvv0));
 //BA.debugLineNum = 248;BA.debugLine="Return (CosD(Angulo)*Radio*Distancia)+CentroX";
if (true) return (float) ((anywheresoftware.b4a.keywords.Common.CosD(_angulo)*_vvvvvvvv5*_distancia)+_vvvvvvvv2);
 }else {
...
if (true) return (float) ((anywheresoftware.b4a.keywords.Common.CosD((_hora+_minuto/(double)60)*(360/(double)12)+270)*_vvvvvvvv5*_distancia)+_vvvvvvvv2);
 };
...
if (true) return (float) ((anywheresoftware.b4a.keywords.Common.SinD(_angulo)*_vvvvvvvv5*_distancia)+_vvvvvvvv3);
 }else {
...
if (true) return (float) ((anywheresoftware.b4a.keywords.Common.SinD((_hora+_minuto/(double)60)*(360/(double)12)+270)*_vvvvvvvv5*_distancia)+_vvvvvvvv3);
 };
 //BA.debugLineNum = 269;BA.debugLine="End Sub";
return 0f;
}
public static String  _vvvvvvv0(int _minuto) throws Exception{
