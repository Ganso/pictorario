...
public static boolean  _application_error(anywheresoftware.b4a.objects.B4AException _error,String _stacktrace) throws Exception{
 //BA.debugLineNum = 226;BA.debugLine="Sub Application_Error (Error As Exception, StackTr";
...
for (;(step2 > 0 && _i <= limit2) || (step2 < 0 && _i >= limit2) ;_i = ((int)(0 + _i + step2))  ) {
 //BA.debugLineNum = 84;BA.debugLine="Secuencia(i)=kvs.Get(\"Secuencia.\"&i)";
_secuencia[_i] = (javi.prieto.pictorario.starter._secuencia)(_kvs._get("Secuencia."+BA.NumberToString(_i)));
 //BA.debugLineNum = 85;BA.debugLine="For j=0 To Secuencia(i).num_actividades";
{
final int step4 = 1;
final int limit4 = _secuencia[_i].num_actividades;
_j = (int) (0) ;
for (;(step4 > 0 && _j <= limit4) || (step4 < 0 && _j >= limit4) ;_j = ((int)(0 + _j + step4))  ) {
 //BA.debugLineNum = 86;BA.debugLine="ActividadSecuencia(i,j)=kvs.Get(\"ActividadSecue";
_actividadsecuencia[_i][_j] = (javi.prieto.pictorario.starter._actividad)(_kvs._get("ActividadSecuencia."+BA.NumberToString(_i)+"."+BA.NumberToString(_j)));
 ...
 //BA.debugLineNum = 89;BA.debugLine="If NumSecuencias==0 Then";
if (_numsecuencias==0) { 
 //BA.debugLineNum = 90;BA.debugLine="Inicializar_Con_Ejemplo";
...
public static String  _inicializar_con_ejemplo() throws Exception{
 //BA.debugLineNum = 94;BA.debugLine="Sub Inicializar_Con_Ejemplo";
 //BA.debugLineNum = 95;BA.debugLine="NumSecuencias=2";
_numsecuencias = (int) (2);
 //BA.debugLineNum = 99;BA.debugLine="Secuencia(0).Initialize";
_secuencia[(int) (0)].Initialize();
 //BA.debugLineNum = 101;BA.debugLine="Secuencia(0).num_actividades=9";
_secuencia[(int) (0)].num_actividades = (int) (9);
 //BA.debugLineNum = 103;BA.debugLine="ActividadSecuencia(0,0).hora_inicio=8";
_actividadsecuencia[(int) (0)][(int) (0)].hora_inicio = (int) (8);
 //BA.debugLineNum = 104;BA.debugLine="ActividadSecuencia(0,0).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (0)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 105;BA.debugLine="ActividadSecuencia(0,0).hora_fin=8";
_actividadsecuencia[(int) (0)][(int) (0)].hora_fin = (int) (8);
 //BA.debugLineNum = 106;BA.debugLine="ActividadSecuencia(0,0).minuto_fin=15";
_actividadsecuencia[(int) (0)][(int) (0)].minuto_fin = (int) (15);
 //BA.debugLineNum = 107;BA.debugLine="ActividadSecuencia(0,0).pictograma=\"despertar_1\"";
_actividadsecuencia[(int) (0)][(int) (0)].Pictograma = "despertar_1";
 //BA.debugLineNum = 108;BA.debugLine="ActividadSecuencia(0,0).descripcion=\"Despertarse\"";
_actividadsecuencia[(int) (0)][(int) (0)].Descripcion = "Despertarse";
 //BA.debugLineNum = 110;BA.debugLine="ActividadSecuencia(0,1).hora_inicio=8";
_actividadsecuencia[(int) (0)][(int) (1)].hora_inicio = (int) (8);
 //BA.debugLineNum = 111;BA.debugLine="ActividadSecuencia(0,1).minuto_inicio=15";
_actividadsecuencia[(int) (0)][(int) (1)].minuto_inicio = (int) (15);
 //BA.debugLineNum = 112;BA.debugLine="ActividadSecuencia(0,1).hora_fin=8";
_actividadsecuencia[(int) (0)][(int) (1)].hora_fin = (int) (8);
 //BA.debugLineNum = 113;BA.debugLine="ActividadSecuencia(0,1).minuto_fin=30";
_actividadsecuencia[(int) (0)][(int) (1)].minuto_fin = (int) (30);
 //BA.debugLineNum = 114;BA.debugLine="ActividadSecuencia(0,1).pictograma=\"vestirse\"";
_actividadsecuencia[(int) (0)][(int) (1)].Pictograma = "vestirse";
 //BA.debugLineNum = 115;BA.debugLine="ActividadSecuencia(0,1).descripcion=\"Vestirse\"";
_actividadsecuencia[(int) (0)][(int) (1)].Descripcion = "Vestirse";
 //BA.debugLineNum = 117;BA.debugLine="ActividadSecuencia(0,2).hora_inicio=8";
_actividadsecuencia[(int) (0)][(int) (2)].hora_inicio = (int) (8);
 //BA.debugLineNum = 118;BA.debugLine="ActividadSecuencia(0,2).minuto_inicio=30";
_actividadsecuencia[(int) (0)][(int) (2)].minuto_inicio = (int) (30);
 //BA.debugLineNum = 119;BA.debugLine="ActividadSecuencia(0,2).hora_fin=9";
_actividadsecuencia[(int) (0)][(int) (2)].hora_fin = (int) (9);
 //BA.debugLineNum = 120;BA.debugLine="ActividadSecuencia(0,2).minuto_fin=0";
_actividadsecuencia[(int) (0)][(int) (2)].minuto_fin = (int) (0);
 //BA.debugLineNum = 121;BA.debugLine="ActividadSecuencia(0,2).pictograma=\"desayunar\"";
_actividadsecuencia[(int) (0)][(int) (2)].Pictograma = "desayunar";
 //BA.debugLineNum = 122;BA.debugLine="ActividadSecuencia(0,2).descripcion=\"Desayunar\"";
_actividadsecuencia[(int) (0)][(int) (2)].Descripcion = "Desayunar";
 //BA.debugLineNum = 124;BA.debugLine="ActividadSecuencia(0,3).hora_inicio=9";
_actividadsecuencia[(int) (0)][(int) (3)].hora_inicio = (int) (9);
 //BA.debugLineNum = 125;BA.debugLine="ActividadSecuencia(0,3).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (3)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 126;BA.debugLine="ActividadSecuencia(0,3).hora_fin=14";
_actividadsecuencia[(int) (0)][(int) (3)].hora_fin = (int) (14);
 //BA.debugLineNum = 127;BA.debugLine="ActividadSecuencia(0,3).minuto_fin=0";
_actividadsecuencia[(int) (0)][(int) (3)].minuto_fin = (int) (0);
 //BA.debugLineNum = 128;BA.debugLine="ActividadSecuencia(0,3).pictograma=\"colegio\"";
_actividadsecuencia[(int) (0)][(int) (3)].Pictograma = "colegio";
 //BA.debugLineNum = 129;BA.debugLine="ActividadSecuencia(0,3).descripcion=\"Cole\"";
_actividadsecuencia[(int) (0)][(int) (3)].Descripcion = "Cole";
 //BA.debugLineNum = 131;BA.debugLine="ActividadSecuencia(0,4).hora_inicio=14";
_actividadsecuencia[(int) (0)][(int) (4)].hora_inicio = (int) (14);
 //BA.debugLineNum = 132;BA.debugLine="ActividadSecuencia(0,4).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (4)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 133;BA.debugLine="ActividadSecuencia(0,4).hora_fin=15";
_actividadsecuencia[(int) (0)][(int) (4)].hora_fin = (int) (15);
 //BA.debugLineNum = 134;BA.debugLine="ActividadSecuencia(0,4).minuto_fin=0";
_actividadsecuencia[(int) (0)][(int) (4)].minuto_fin = (int) (0);
 //BA.debugLineNum = 135;BA.debugLine="ActividadSecuencia(0,4).pictograma=\"comer\"";
_actividadsecuencia[(int) (0)][(int) (4)].Pictograma = "comer";
 //BA.debugLineNum = 136;BA.debugLine="ActividadSecuencia(0,4).descripcion=\"Comer\"";
_actividadsecuencia[(int) (0)][(int) (4)].Descripcion = "Comer";
 //BA.debugLineNum = 138;BA.debugLine="ActividadSecuencia(0,5).hora_inicio=15";
_actividadsecuencia[(int) (0)][(int) (5)].hora_inicio = (int) (15);
 //BA.debugLineNum = 139;BA.debugLine="ActividadSecuencia(0,5).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (5)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 140;BA.debugLine="ActividadSecuencia(0,5).hora_fin=20";
_actividadsecuencia[(int) (0)][(int) (5)].hora_fin = (int) (20);
 //BA.debugLineNum = 141;BA.debugLine="ActividadSecuencia(0,5).minuto_fin=0";
_actividadsecuencia[(int) (0)][(int) (5)].minuto_fin = (int) (0);
 //BA.debugLineNum = 142;BA.debugLine="ActividadSecuencia(0,5).pictograma=\"juguete\"";
_actividadsecuencia[(int) (0)][(int) (5)].Pictograma = "juguete";
 //BA.debugLineNum = 143;BA.debugLine="ActividadSecuencia(0,5).descripcion=\"Jugar\"";
_actividadsecuencia[(int) (0)][(int) (5)].Descripcion = "Jugar";
 //BA.debugLineNum = 145;BA.debugLine="ActividadSecuencia(0,6).hora_inicio=20";
_actividadsecuencia[(int) (0)][(int) (6)].hora_inicio = (int) (20);
 //BA.debugLineNum = 146;BA.debugLine="ActividadSecuencia(0,6).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (6)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 147;BA.debugLine="ActividadSecuencia(0,6).hora_fin=20";
_actividadsecuencia[(int) (0)][(int) (6)].hora_fin = (int) (20);
 //BA.debugLineNum = 148;BA.debugLine="ActividadSecuencia(0,6).minuto_fin=30";
_actividadsecuencia[(int) (0)][(int) (6)].minuto_fin = (int) (30);
 //BA.debugLineNum = 149;BA.debugLine="ActividadSecuencia(0,6).pictograma=\"ban_arse\"";
_actividadsecuencia[(int) (0)][(int) (6)].Pictograma = "ban_arse";
 //BA.debugLineNum = 150;BA.debugLine="ActividadSecuencia(0,6).descripcion=\"Bañarse\"";
_actividadsecuencia[(int) (0)][(int) (6)].Descripcion = "Bañarse";
 //BA.debugLineNum = 152;BA.debugLine="ActividadSecuencia(0,7).hora_inicio=20";
_actividadsecuencia[(int) (0)][(int) (7)].hora_inicio = (int) (20);
 //BA.debugLineNum = 153;BA.debugLine="ActividadSecuencia(0,7).minuto_inicio=30";
_actividadsecuencia[(int) (0)][(int) (7)].minuto_inicio = (int) (30);
 //BA.debugLineNum = 154;BA.debugLine="ActividadSecuencia(0,7).hora_fin=21";
_actividadsecuencia[(int) (0)][(int) (7)].hora_fin = (int) (21);
 //BA.debugLineNum = 155;BA.debugLine="ActividadSecuencia(0,7).minuto_fin=0";
_actividadsecuencia[(int) (0)][(int) (7)].minuto_fin = (int) (0);
 //BA.debugLineNum = 156;BA.debugLine="ActividadSecuencia(0,7).pictograma=\"cenar_2\"";
_actividadsecuencia[(int) (0)][(int) (7)].Pictograma = "cenar_2";
 //BA.debugLineNum = 157;BA.debugLine="ActividadSecuencia(0,7).descripcion=\"Cenar\"";
_actividadsecuencia[(int) (0)][(int) (7)].Descripcion = "Cenar";
 //BA.debugLineNum = 159;BA.debugLine="ActividadSecuencia(0,8).hora_inicio=21";
_actividadsecuencia[(int) (0)][(int) (8)].hora_inicio = (int) (21);
 //BA.debugLineNum = 160;BA.debugLine="ActividadSecuencia(0,8).minuto_inicio=0";
_actividadsecuencia[(int) (0)][(int) (8)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 161;BA.debugLine="ActividadSecuencia(0,8).hora_fin=21";
_actividadsecuencia[(int) (0)][(int) (8)].hora_fin = (int) (21);
 //BA.debugLineNum = 162;BA.debugLine="ActividadSecuencia(0,8).minuto_fin=30";
_actividadsecuencia[(int) (0)][(int) (8)].minuto_fin = (int) (30);
 //BA.debugLineNum = 163;BA.debugLine="ActividadSecuencia(0,8).pictograma=\"dormir_1\"";
_actividadsecuencia[(int) (0)][(int) (8)].Pictograma = "dormir_1";
 //BA.debugLineNum = 164;BA.debugLine="ActividadSecuencia(0,8).descripcion=\"Acostarse\"";
_actividadsecuencia[(int) (0)][(int) (8)].Descripcion = "Acostarse";
 //BA.debugLineNum = 166;BA.debugLine="Secuencia(0).tablero.tipo=2";
_secuencia[(int) (0)].tablero.tipo = (int) (2);
 //BA.debugLineNum = 167;BA.debugLine="Secuencia(0).tablero.indicar_hora=3";
_secuencia[(int) (0)].tablero.indicar_hora = (int) (3);
 //BA.debugLineNum = 168;BA.debugLine="Secuencia(0).tablero.tam_icono=10";
_secuencia[(int) (0)].tablero.tam_icono = (int) (10);
 //BA.debugLineNum = 170;BA.debugLine="Secuencia(0).pictograma=\"colegio\"";
_secuencia[(int) (0)].pictograma = "colegio";
 //BA.debugLineNum = 171;BA.debugLine="Secuencia(0).descripcion=\"Secuencia de prueba de";
_secuencia[(int) (0)].Descripcion = "Secuencia de prueba de día completo";
 //BA.debugLineNum = 175;BA.debugLine="Secuencia(1).Initialize";
_secuencia[(int) (1)].Initialize();
 //BA.debugLineNum = 177;BA.debugLine="Secuencia(1).num_actividades=4";
_secuencia[(int) (1)].num_actividades = (int) (4);
 //BA.debugLineNum = 179;BA.debugLine="ActividadSecuencia(1,0).hora_inicio=8";
_actividadsecuencia[(int) (1)][(int) (0)].hora_inicio = (int) (8);
 //BA.debugLineNum = 180;BA.debugLine="ActividadSecuencia(1,0).minuto_inicio=0";
_actividadsecuencia[(int) (1)][(int) (0)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 181;BA.debugLine="ActividadSecuencia(1,0).hora_fin=8";
_actividadsecuencia[(int) (1)][(int) (0)].hora_fin = (int) (8);
 //BA.debugLineNum = 182;BA.debugLine="ActividadSecuencia(1,0).minuto_fin=15";
_actividadsecuencia[(int) (1)][(int) (0)].minuto_fin = (int) (15);
 //BA.debugLineNum = 183;BA.debugLine="ActividadSecuencia(1,0).pictograma=\"despertar_1\"";
_actividadsecuencia[(int) (1)][(int) (0)].Pictograma = "despertar_1";
 //BA.debugLineNum = 184;BA.debugLine="ActividadSecuencia(1,0).descripcion=\"Despertarse\"";
_actividadsecuencia[(int) (1)][(int) (0)].Descripcion = "Despertarse";
 //BA.debugLineNum = 186;BA.debugLine="ActividadSecuencia(1,1).hora_inicio=8";
_actividadsecuencia[(int) (1)][(int) (1)].hora_inicio = (int) (8);
 //BA.debugLineNum = 187;BA.debugLine="ActividadSecuencia(1,1).minuto_inicio=15";
_actividadsecuencia[(int) (1)][(int) (1)].minuto_inicio = (int) (15);
 //BA.debugLineNum = 188;BA.debugLine="ActividadSecuencia(1,1).hora_fin=8";
_actividadsecuencia[(int) (1)][(int) (1)].hora_fin = (int) (8);
 //BA.debugLineNum = 189;BA.debugLine="ActividadSecuencia(1,1).minuto_fin=30";
_actividadsecuencia[(int) (1)][(int) (1)].minuto_fin = (int) (30);
 //BA.debugLineNum = 190;BA.debugLine="ActividadSecuencia(1,1).pictograma=\"vestirse\"";
_actividadsecuencia[(int) (1)][(int) (1)].Pictograma = "vestirse";
 //BA.debugLineNum = 191;BA.debugLine="ActividadSecuencia(1,1).descripcion=\"Vestirse\"";
_actividadsecuencia[(int) (1)][(int) (1)].Descripcion = "Vestirse";
 //BA.debugLineNum = 193;BA.debugLine="ActividadSecuencia(1,2).hora_inicio=8";
_actividadsecuencia[(int) (1)][(int) (2)].hora_inicio = (int) (8);
 //BA.debugLineNum = 194;BA.debugLine="ActividadSecuencia(1,2).minuto_inicio=30";
_actividadsecuencia[(int) (1)][(int) (2)].minuto_inicio = (int) (30);
 //BA.debugLineNum = 195;BA.debugLine="ActividadSecuencia(1,2).hora_fin=9";
_actividadsecuencia[(int) (1)][(int) (2)].hora_fin = (int) (9);
 //BA.debugLineNum = 196;BA.debugLine="ActividadSecuencia(1,2).minuto_fin=0";
_actividadsecuencia[(int) (1)][(int) (2)].minuto_fin = (int) (0);
 //BA.debugLineNum = 197;BA.debugLine="ActividadSecuencia(1,2).pictograma=\"desayunar\"";
_actividadsecuencia[(int) (1)][(int) (2)].Pictograma = "desayunar";
 //BA.debugLineNum = 198;BA.debugLine="ActividadSecuencia(1,2).descripcion=\"Desayunar\"";
_actividadsecuencia[(int) (1)][(int) (2)].Descripcion = "Desayunar";
 //BA.debugLineNum = 200;BA.debugLine="ActividadSecuencia(1,3).hora_inicio=9";
_actividadsecuencia[(int) (1)][(int) (3)].hora_inicio = (int) (9);
 //BA.debugLineNum = 201;BA.debugLine="ActividadSecuencia(1,3).minuto_inicio=0";
_actividadsecuencia[(int) (1)][(int) (3)].minuto_inicio = (int) (0);
 //BA.debugLineNum = 202;BA.debugLine="ActividadSecuencia(1,3).hora_fin=14";
_actividadsecuencia[(int) (1)][(int) (3)].hora_fin = (int) (14);
 //BA.debugLineNum = 203;BA.debugLine="ActividadSecuencia(1,3).minuto_fin=0";
_actividadsecuencia[(int) (1)][(int) (3)].minuto_fin = (int) (0);
 //BA.debugLineNum = 204;BA.debugLine="ActividadSecuencia(1,3).pictograma=\"colegio\"";
_actividadsecuencia[(int) (1)][(int) (3)].Pictograma = "colegio";
 //BA.debugLineNum = 205;BA.debugLine="ActividadSecuencia(1,3).descripcion=\"Cole\"";
_actividadsecuencia[(int) (1)][(int) (3)].Descripcion = "Cole";
 //BA.debugLineNum = 207;BA.debugLine="Secuencia(1).tablero.tipo=3";
_secuencia[(int) (1)].tablero.tipo = (int) (3);
 //BA.debugLineNum = 208;BA.debugLine="Secuencia(1).tablero.indicar_hora=3";
_secuencia[(int) (1)].tablero.indicar_hora = (int) (3);
 //BA.debugLineNum = 209;BA.debugLine="Secuencia(1).tablero.tam_icono=20";
_secuencia[(int) (1)].tablero.tam_icono = (int) (20);
 //BA.debugLineNum = 211;BA.debugLine="Secuencia(1).pictograma=\"despertar_1\"";
_secuencia[(int) (1)].pictograma = "despertar_1";
 //BA.debugLineNum = 213;BA.debugLine="Secuencia(1).descripcion=\"Mañana de día laborable";
...
_descripcionminutero = new String[]{"Sin indicación","Indicar hora","Indicar hora y minutos","Indicar hora, minutos y segundos"};
 //BA.debugLineNum = 45;BA.debugLine="Dim MaxColores=11 As Int";
_maxcolores = (int) (11);
...
_numsecuencias = (int) (0);
 //BA.debugLineNum = 63;BA.debugLine="kvs.Initialize(File.DirDefaultExternal, \"configur";
...
public static String  _service_destroy() throws Exception{
 //BA.debugLineNum = 230;BA.debugLine="Sub Service_Destroy";
 //BA.debugLineNum = 232;BA.debugLine="End Sub";
return "";
}
public static String  _service_start(anywheresoftware.b4a.objects.IntentWrapper _startingintent) throws Exception{
 //BA.debugLineNum = 217;BA.debugLine="Sub Service_Start (StartingIntent As Intent)";
 //BA.debugLineNum = 219;BA.debugLine="End Sub";
return "";
}
public static String  _service_taskremoved() throws Exception{
 //BA.debugLineNum = 221;BA.debugLine="Sub Service_TaskRemoved";
