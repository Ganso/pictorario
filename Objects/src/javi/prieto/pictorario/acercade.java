...
public static String  _activity_create(boolean _firsttime) throws Exception{
 ...
 //BA.debugLineNum = 28;BA.debugLine="Activity.LoadLayout(\"AcercaDe\")";
mostCurrent._activity.LoadLayout("AcercaDe",mostCurrent.activityBA);
 //BA.debugLineNum = 30;BA.debugLine="TextoAutor.LoadHtml(\"<html><body><center>\"& _ 	\"<";
...
mostCurrent._textoarasaac.LoadHtml("<html><body><center>"+"<strong>Pictogramas</strong>: Sergio Palao<br />"+"<strong>Procedencia</strong>: ARASAAC (www.arasaac.org)<br />"+"<strong>Licencia</strong>: CC (BY-NC-SA)<br />"+"<strong>Propiedad</strong>: Gobierno de Aragón<br />"+"</center></body></html>");
 //BA.debugLineNum = 42;BA.debugLine="ParaTeo.Typeface=Typeface.LoadFromAssets(\"GreatVi";
mostCurrent._parateo.setTypeface(anywheresoftware.b4a.keywords.Common.Typeface.LoadFromAssets("GreatVibes-Regular.ttf"));
 //BA.debugLineNum = 44;BA.debugLine="VersionApp.Text=Application.VersionName";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 71;BA.debugLine="Sub Logotipo_Click";
 //BA.debugLineNum = 72;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 73;BA.debugLine="StartActivity(p.OpenBrowser(\"http://blog.ganso.or";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 66;BA.debugLine="Sub Pictogramas_Click";
 //BA.debugLineNum = 67;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 68;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.arasaac.o";
...
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 61;BA.debugLine="Sub Programador_Click";
 //BA.debugLineNum = 62;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 63;BA.debugLine="StartActivity(p.OpenBrowser(\"http://www.ganso.org";
...
anywheresoftware.b4a.keywords.Common.Msgbox2(BA.ObjectToCharSequence("Novedades de la versión:"+anywheresoftware.b4a.keywords.Common.CRLF+anywheresoftware.b4a.keywords.Common.CRLF+mostCurrent._vvvv2._v6),BA.ObjectToCharSequence("Versión "+anywheresoftware.b4a.keywords.Common.Application.getVersionName()),"Continuar","","",(android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.Null),mostCurrent.activityBA);
 //BA.debugLineNum = 94;BA.debugLine="End Sub";
return "";
}
public static String  _vervideo_click() throws Exception{
anywheresoftware.b4a.phone.Phone.PhoneIntents _p = null;
 //BA.debugLineNum = 76;BA.debugLine="Sub VerVideo_Click";
 //BA.debugLineNum = 77;BA.debugLine="Dim p As PhoneIntents";
_p = new anywheresoftware.b4a.phone.Phone.PhoneIntents();
 //BA.debugLineNum = 79;BA.debugLine="StartActivity(p.OpenBrowser(\"http://Bit.ly/VideoP";
...
public static String  _volver_click() throws Exception{
 //BA.debugLineNum = 57;BA.debugLine="Sub Volver_Click";
