...
public anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _vvvvvvvvvvvvvvvvvvvv0 = null;
...
public anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _vvvvvvvvvvvvvvvvvvvvv3 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvvvvvvv4 = null;
...
public anywheresoftware.b4a.objects.ButtonWrapper _vvvvvvvvvvvvvvvvvvvvv6 = null;
...
public anywheresoftware.b4a.objects.ButtonWrapper _vvvvvvvvvvvvvvvvvvvvvv1 = null;
...
mostCurrent._vvvvvvvvvv3._vvv6 /*boolean*/  = mostCurrent._vvvvvvvvvvvvvvvvvvvv0.getChecked();
...
mostCurrent._activity.LoadLayout("Configuracion",mostCurrent.activityBA);
 //BA.debugLineNum = 34;BA.debugLine="Dim Separador=10dip,Altura=80dip As Int";
...
mostCurrent._vvvvvvvvvvvvvvvvvvvv0.Initialize(mostCurrent.activityBA,"ActivarAlarmasCheck");
 //BA.debugLineNum = 37;BA.debugLine="ActivarAlarmasIcono.Initialize(\"ActivarAlarmasIco";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv1.Initialize(mostCurrent.activityBA,"ActivarAlarmasIcono");
 //BA.debugLineNum = 38;BA.debugLine="ActivarAlarmasLabel.Initialize(\"ActivarAlarmasLab";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.Initialize(mostCurrent.activityBA,"ActivarAlarmasLabel");
 //BA.debugLineNum = 39;BA.debugLine="ProtegerVisualizacionCheck.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv3.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionCheck");
 //BA.debugLineNum = 40;BA.debugLine="ProtegerVisualizacionIcono.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionIcono");
 //BA.debugLineNum = 41;BA.debugLine="ProtegerVisualizacionLabel.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionLabel");
 //BA.debugLineNum = 42;BA.debugLine="FormatoHorasButton.Initialize(\"FormatoHorasButton";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.Initialize(mostCurrent.activityBA,"FormatoHorasButton");
 //BA.debugLineNum = 43;BA.debugLine="FormatoHorasLabel.Initialize(\"FormatoHorasLabel\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.Initialize(mostCurrent.activityBA,"FormatoHorasLabel");
 //BA.debugLineNum = 44;BA.debugLine="ColoresRelojLabel.Initialize(\"ColoresRelojLabel\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.Initialize(mostCurrent.activityBA,"ColoresRelojLabel");
 //BA.debugLineNum = 45;BA.debugLine="BotonHoras.Initialize(\"BotonHoras\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.Initialize(mostCurrent.activityBA,"BotonHoras");
 //BA.debugLineNum = 46;BA.debugLine="BotonMinutos.Initialize(\"BotonMinutos\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv2.Initialize(mostCurrent.activityBA,"BotonMinutos");
 //BA.debugLineNum = 47;BA.debugLine="BotonSegundos.Initialize(\"BotonSegundos\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv3.Initialize(mostCurrent.activityBA,"BotonSegundos");
 //BA.debugLineNum = 48;BA.debugLine="BotonReiniciar.Initialize(\"BotonReiniciar\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.Initialize(mostCurrent.activityBA,"BotonReiniciar");
 //BA.debugLineNum = 49;BA.debugLine="BotonVolver.Initialize(\"BotonVolver\")";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv5.Initialize(mostCurrent.activityBA,"BotonVolver");
 //BA.debugLineNum = 51;BA.debugLine="ActivarAlarmasLabel.Text=\"Activar alarmas\"";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.setText(BA.ObjectToCharSequence("Activar alarmas"));
 //BA.debugLineNum = 52;BA.debugLine="ActivarAlarmasLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.setTextSize((float) (16));
 //BA.debugLineNum = 53;BA.debugLine="ActivarAlarmasLabel.Gravity=Gravity.CENTER_VERTIC";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 55;BA.debugLine="ProtegerVisualizacionLabel.Text=\"Proteger aplicac";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.setText(BA.ObjectToCharSequence("Proteger aplicación"));
 //BA.debugLineNum = 56;BA.debugLine="ProtegerVisualizacionLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.setTextSize((float) (16));
 //BA.debugLineNum = 57;BA.debugLine="ProtegerVisualizacionLabel.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 59;BA.debugLine="FormatoHorasLabel.Text=\"Formato horario\"";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.setText(BA.ObjectToCharSequence("Formato horario"));
 //BA.debugLineNum = 60;BA.debugLine="FormatoHorasLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.setTextSize((float) (16));
 //BA.debugLineNum = 61;BA.debugLine="FormatoHorasLabel.Gravity=Gravity.CENTER_VERTICAL";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 63;BA.debugLine="ActivarAlarmasCheck.Checked=Starter.AlarmasActiva";
mostCurrent._vvvvvvvvvvvvvvvvvvvv0.setChecked(mostCurrent._vvvvvvvvvv3._vvv6 /*boolean*/ );
 //BA.debugLineNum = 64;BA.debugLine="ActivarAlarmasCheck.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvvvv0.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 66;BA.debugLine="ProtegerVisualizacionCheck.Checked=Starter.Aplica";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv3.setChecked(mostCurrent._vvvvvvvvvv3._vvv7 /*boolean*/ );
 //BA.debugLineNum = 67;BA.debugLine="ProtegerVisualizacionCheck.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv3.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 69;BA.debugLine="ColoresRelojLabel.Text=\"Colores del reloj (horari";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.setText(BA.ObjectToCharSequence("Colores del reloj (horario, minutero y segundero)"));
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.setColor(mostCurrent._vvvvvvvvvv3._vvvv1 /*int*/ );
 //BA.debugLineNum = 74;BA.debugLine="BotonMinutos.Color=Starter.ColorMinutos";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv2.setColor(mostCurrent._vvvvvvvvvv3._vvvv2 /*int*/ );
 //BA.debugLineNum = 75;BA.debugLine="BotonSegundos.Color=Starter.ColorSegundos";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv3.setColor(mostCurrent._vvvvvvvvvv3._vvvv3 /*int*/ );
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.setText(BA.ObjectToCharSequence("24 horas"));
 }else {
 //BA.debugLineNum = 80;BA.debugLine="FormatoHorasButton.Text=\"12 horas\"";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.setText(BA.ObjectToCharSequence("12 horas"));
 };
 //BA.debugLineNum = 82;BA.debugLine="FormatoHorasButton.TextSize=20";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.setTextSize((float) (20));
 //BA.debugLineNum = 83;BA.debugLine="FormatoHorasButton.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 85;BA.debugLine="BotonReiniciar.Text=\"Reiniciar configuración\"";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.setText(BA.ObjectToCharSequence("Reiniciar configuración"));
 //BA.debugLineNum = 86;BA.debugLine="BotonReiniciar.TextSize=20";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.setTextSize((float) (20));
 //BA.debugLineNum = 87;BA.debugLine="BotonReiniciar.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 89;BA.debugLine="BotonVolver.Text=\"Volver a la portada\"";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv5.setText(BA.ObjectToCharSequence("Volver a la portada"));
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvv1.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"alarma.png").getObject()));
 //BA.debugLineNum = 94;BA.debugLine="ProtegerVisualizacionIcono.SetBackgroundImage(Loa";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"llave.png").getObject()));
 //BA.debugLineNum = 96;BA.debugLine="PanelScroll.Panel.AddView(ActivarAlarmasLabel,10d";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_altura-4*_separador),_altura);
...
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvv0.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv1.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv1.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv1.getTop(),_altura,_altura);
 //BA.debugLineNum = 100;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionLa";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getObject()),mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getWidth(),mostCurrent._vvvvvvvvvvvvvvvvvvvvv2.getHeight());
 //BA.debugLineNum = 101;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionIc";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getTop(),_altura,_altura);
 //BA.debugLineNum = 102;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionCh";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv3.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getTop(),_altura,mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 104;BA.debugLine="PanelScroll.Panel.AddView(FormatoHorasLabel,Prote";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getObject()),mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getWidth(),mostCurrent._vvvvvvvvvvvvvvvvvvvvv5.getHeight());
 //BA.debugLineNum = 105;BA.debugLine="PanelScroll.Panel.AddView(FormatoHorasButton,Prot";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv6.getObject()),mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.getLeft(),mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getTop(),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._vvvvvvvvvvvvvvvvvvvvv4.getLeft()-_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getHeight());
 //BA.debugLineNum = 107;BA.debugLine="PanelScroll.Panel.AddView(ColoresRelojLabel,Forma";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getObject()),mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getWidth(),mostCurrent._vvvvvvvvvvvvvvvvvvvvv7.getHeight());
 //BA.debugLineNum = 109;BA.debugLine="Dim TamBotonesColores=(100%X-ColoresRelojLabel.Le";
_tambotonescolores = (int) ((anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getLeft()-mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getWidth()-4*_separador)/(double)3);
 //BA.debugLineNum = 110;BA.debugLine="PanelScroll.Panel.AddView(BotonHoras,ColoresReloj";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 111;BA.debugLine="PanelScroll.Panel.AddView(BotonMinutos,BotonHoras";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvvv2.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 112;BA.debugLine="PanelScroll.Panel.AddView(BotonSegundos,BotonMinu";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvvv3.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvvv2.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvvvvvvv2.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 114;BA.debugLine="PanelScroll.Panel.AddView(BotonReiniciar,Separado";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.getObject()),_separador,(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvv0.getHeight()+_separador),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_separador),_altura);
 //BA.debugLineNum = 116;BA.debugLine="PanelScroll.Panel.AddView(BotonVolver,Separador,B";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvvvvvv5.getObject()),_separador,(int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvvv4.getHeight()+_separador),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_separador),_altura);
 //BA.debugLineNum = 118;BA.debugLine="PanelScroll.Panel.Height=BotonVolver.Top+BotonVol";
mostCurrent._panelscroll.getPanel().setHeight((int) (mostCurrent._vvvvvvvvvvvvvvvvvvvvvv5.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvvvvvv5.getHeight()+_separador));
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv3._vvvv1 /*int*/ );
...
mostCurrent._vvvvvvvvvv3._vvvv1 /*int*/  = _dialogocolor.getRGB();
 //BA.debugLineNum = 152;BA.debugLine="BotonHoras.Color=DialogoColor.RGB";
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1.setColor(_dialogocolor.getRGB());
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv3._vvvv2 /*int*/ );
...
mostCurrent._vvvvvvvvvv3._vvvv2 /*int*/  = _dialogocolor.getRGB();
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv3._vvvv3 /*int*/ );
...
mostCurrent._vvvvvvvvvv3._vvvv3 /*int*/  = _dialogocolor.getRGB();
...
mostCurrent._vvvvvvvvvv3._vvv0 /*boolean*/  = anywheresoftware.b4a.keywords.Common.Not(mostCurrent._vvvvvvvvvv3._vvv0 /*boolean*/ );
...
mostCurrent._vvvvvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 17;BA.debugLine="Private ProtegerVisualizacionIcono As Label";
mostCurrent._vvvvvvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.ButtonWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvvvvvvvv1 = new anywheresoftware.b4a.objects.ButtonWrapper();
...
mostCurrent._vvvvvvvvvv3._vvv7 /*boolean*/  = mostCurrent._vvvvvvvvvvvvvvvvvvvvv3.getChecked();
