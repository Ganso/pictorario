...
public static String _vvvvvvvvvvvvvvvv0 = "";
...
mostCurrent._barrabusqueda.setText(BA.ObjectToCharSequence(mostCurrent._vvvvvvvvvvvvvvvv0));
 //BA.debugLineNum = 39;BA.debugLine="TamIcono=ListadoPictogramas.Width/3";
_vvvvvvvvvvvvvvvvv1 = (int) (mostCurrent._listadopictogramas.getWidth()/(double)3);
...
//C
this.state = 1;
 //BA.debugLineNum = 252;BA.debugLine="If KeyCode = KeyCodes.KEYCODE_BACK Then 'Al pulsa";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 253;BA.debugLine="Sleep(0) 'No hace nada";
...
if (_tienefoco==anywheresoftware.b4a.keywords.Common.True && (mostCurrent._barrabusqueda.getText()).equals(mostCurrent._vvvvvvvvvvvvvvvv0)) { 
...
public static String  _botoncancelar_click() throws Exception{
 //BA.debugLineNum = 198;BA.debugLine="Sub BotonCancelar_Click";
 //BA.debugLineNum = 199;BA.debugLine="CallSubDelayed2(ConfigurarSecuencia,\"PictogramaEl";
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,(Object)(mostCurrent._vvvvvvvvv4.getObject()),"PictogramaElegido",(Object)(-1));
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,(Object)(mostCurrent._vvvvvvvvv4.getObject()),"PictogramaElegido",_botonpulsado.getTag());
 //BA.debugLineNum = 55;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 56;BA.debugLine="End Sub";
return "";
}
public static void  _vvvvvvvvvvvvvvvvv3() throws Exception{
...
//if
this.state = 49;
if ((parent.mostCurrent._barrabusqueda.getText()).equals(parent.mostCurrent._vvvvvvvvvvvvvvvv0) == false) { 
this.state = 3;
}if (true) break;
...
//C
this.state = 52;
 //BA.debugLineNum = 99;BA.debugLine="id(encontrados)=Pictograma.Get(\"_id\")";
...
//if
this.state = 20;
if (anywheresoftware.b4a.keywords.Common.File.Exists(parent.mostCurrent._vvvvvvvvvv3._vvvv5 /*String*/ ,BA.NumberToString(_id[_i])+".png")==anywheresoftware.b4a.keywords.Common.False) { 
this.state = 19;
}if (true) break;
...
//C
this.state = 20;
 //BA.debugLineNum = 117;BA.debugLine="URL(i)=\"https://static.arasaac.org/pictograms/";
...
if (true) break;
;
 //BA.debugLineNum = 121;BA.debugLine="For i=0 To encontrados-1";
...
//C
this.state = 24;
 //BA.debugLineNum = 122;BA.debugLine="If File.Exists(Starter.DirPictogramas,id(i)&\".p";
if (true) break;
...
//C
this.state = 27;
 //BA.debugLineNum = 123;BA.debugLine="Wait For (DescargarPictograma(id(i),URL(i)))";
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _vvvvvvvvvvvvvvvvv4(_id[_i],_url[_i]));
this.state = 57;
return;
case 57:
//C
...
this.state = 29;
;
 //BA.debugLineNum = 127;BA.debugLine="ProgressDialogShow(\"Preparando listado\")";
anywheresoftware.b4a.keywords.Common.ProgressDialogShow(mostCurrent.activityBA,BA.ObjectToCharSequence("Preparando listado"));
 //BA.debugLineNum = 129;BA.debugLine="For x=0 To NumColumnas-1";
if (true) break;
...
this.state = 36;
step40 = 1;
limit40 = (int) (parent._vvvvvvvvvvvvvvvvv5-1);
_x = (int) (0) ;
this.state = 58;
if (true) break;
...
//C
this.state = 32;
 //BA.debugLineNum = 130;BA.debugLine="For y=0 To NumLineas-1";
if (true) break;
...
this.state = 35;
step41 = 1;
limit41 = (int) (parent._vvvvvvvvvvvvvvvvv6-1);
_y = (int) (0) ;
this.state = 60;
if (true) break;
...
//C
this.state = 61;
 //BA.debugLineNum = 131;BA.debugLine="BotonIcono(y,x).Visible=False 'Oculta todos lo";
parent.mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 if (true) break;
if (true) break;
...
this.state = 37;
;
 //BA.debugLineNum = 135;BA.debugLine="x=0";
_x = (int) (0);
 //BA.debugLineNum = 136;BA.debugLine="y=0";
_y = (int) (0);
 //BA.debugLineNum = 137;BA.debugLine="For i=0 To encontrados-1 'Muestra los nuevos ico";
if (true) break;
...
//C
this.state = 40;
 //BA.debugLineNum = 138;BA.debugLine="If y<NumLineas Then";
if (true) break;

case 40:
//if
this.state = 47;
if (_y<parent._vvvvvvvvvvvvvvvvv6) { 
this.state = 42;
}if (true) break;
...
//C
this.state = 43;
 //BA.debugLineNum = 139;BA.debugLine="BotonIcono(y,x).SetBackgroundImage(LoadBitmap(";
parent.mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"/pictogramas"),BA.NumberToString(_id[_i])+".png").getObject()));
 //BA.debugLineNum = 140;BA.debugLine="BotonIcono(y,x).Tag=id(i)";
parent.mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setTag((Object)(_id[_i]));
 //BA.debugLineNum = 141;BA.debugLine="BotonIcono(y,x).Visible=True";
parent.mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 142;BA.debugLine="ListadoPictogramas.Panel.Height=(y+1)*TamIcono";
parent.mostCurrent._listadopictogramas.getPanel().setHeight((int) ((_y+1)*parent._vvvvvvvvvvvvvvvvv1));
 //BA.debugLineNum = 143;BA.debugLine="x=x+1";
_x = (int) (_x+1);
 //BA.debugLineNum = 144;BA.debugLine="If (x=NumColumnas) Then";
if (true) break;

case 43:
//if
this.state = 46;
if ((_x==parent._vvvvvvvvvvvvvvvvv5)) { 
this.state = 45;
}if (true) break;
...
//C
this.state = 46;
 //BA.debugLineNum = 145;BA.debugLine="x=0";
_x = (int) (0);
 //BA.debugLineNum = 146;BA.debugLine="y=y+1";
_y = (int) (_y+1);
 if (true) break;
...
public static anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvvvvvvv4(int _id,String _url) throws Exception{
...
//C
this.state = 1;
 //BA.debugLineNum = 158;BA.debugLine="Dim Web3 As HttpJob";
_web3 = new javi.prieto.pictorario.httpjob();
 //BA.debugLineNum = 159;BA.debugLine="Web3.Initialize(\"bajapictograma\",Me)";
_web3._initialize /*String*/ (processBA,"bajapictograma",seleccionpictogramas.getObject());
 //BA.debugLineNum = 160;BA.debugLine="Web3.Download(URL)";
_web3._vvvvv2 /*String*/ (_url);
 //BA.debugLineNum = 162;BA.debugLine="Wait For (Web3) JobDone(j3 As HttpJob)";
...
;
 //BA.debugLineNum = 163;BA.debugLine="If j3.Success Then";
if (true) break;
...
//C
this.state = 4;
 //BA.debugLineNum = 164;BA.debugLine="Dim Fichero As OutputStream";
_fichero = new anywheresoftware.b4a.objects.streams.File.OutputStreamWrapper();
 //BA.debugLineNum = 165;BA.debugLine="Fichero = File.OpenOutput(Starter.DirPictogramas";
_fichero = anywheresoftware.b4a.keywords.Common.File.OpenOutput(parent.mostCurrent._vvvvvvvvvv3._vvvv5 /*String*/ ,BA.NumberToString(_id)+".png",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 166;BA.debugLine="File.Copy2(Web3.GetInputStream, Fichero)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_web3._vvvvv0 /*anywheresoftware.b4a.objects.streams.File.InputStreamWrapper*/ ().getObject()),(java.io.OutputStream)(_fichero.getObject()));
 //BA.debugLineNum = 167;BA.debugLine="Fichero.Close";
_fichero.Close();
 if (true) break;
...
this.state = -1;
;
 //BA.debugLineNum = 169;BA.debugLine="j3.Release";
_j3._vvvvvvv6 /*String*/ ();
 //BA.debugLineNum = 170;BA.debugLine="Web3.Release";
_web3._vvvvvvv6 /*String*/ ();
 //BA.debugLineNum = 171;BA.debugLine="Return 0";
if (true) {
...
int _x = 0;
int _y = 0;
 //BA.debugLineNum = 203;BA.debugLine="Sub DibujaIconos";
 //BA.debugLineNum = 204;BA.debugLine="Dim x,y As Int";
_x = 0;
_y = 0;
 //BA.debugLineNum = 206;BA.debugLine="For x=0 To NumColumnas-1";
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvvvvvvv5-1);
_x = (int) (0) ;
for (;_x <= limit2 ;_x = _x + step2 ) {
 //BA.debugLineNum = 207;BA.debugLine="For y=0 To NumLineas-1";
{
final int step3 = 1;
final int limit3 = (int) (_vvvvvvvvvvvvvvvvv6-1);
_y = (int) (0) ;
for (;_y <= limit3 ;_y = _y + step3 ) {
 //BA.debugLineNum = 208;BA.debugLine="BotonIcono(y,x).Initialize(\"BotonIcono\")";
mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].Initialize(mostCurrent.activityBA,"BotonIcono");
 //BA.debugLineNum = 209;BA.debugLine="ListadoPictogramas.Panel.AddView(BotonIcono(y,x";
mostCurrent._listadopictogramas.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].getObject()),(int) (_x*_vvvvvvvvvvvvvvvvv1),(int) (_y*_vvvvvvvvvvvvvvvvv1),_vvvvvvvvvvvvvvvvv1,_vvvvvvvvvvvvvvvvv1);
 //BA.debugLineNum = 210;BA.debugLine="BotonIcono(y,x).Visible=False";
mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 }
};
 }
};
 //BA.debugLineNum = 213;BA.debugLine="ListadoPictogramas.Panel.Height=0 'Ningún icono v";
mostCurrent._listadopictogramas.getPanel().setHeight((int) (0));
 //BA.debugLineNum = 215;BA.debugLine="RellenarIconos";
_vvvvvvvvvvvvvvvvv0();
...
mostCurrent._vvvvvvvvvvvvvvvv0 = "Buscar pictograma por texto";
 //BA.debugLineNum = 24;BA.debugLine="Dim NumColumnas As Int = 3";
_vvvvvvvvvvvvvvvvv5 = (int) (3);
 //BA.debugLineNum = 25;BA.debugLine="Dim NumLineas As Int = 20";
_vvvvvvvvvvvvvvvvv6 = (int) (20);
 //BA.debugLineNum = 28;BA.debugLine="Dim BotonIcono(NumLineas,NumColumnas) As Button";
mostCurrent._vvvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.ButtonWrapper[_vvvvvvvvvvvvvvvvv6][];
{
int d0 = mostCurrent._vvvvvvvvvvvvvvvvv7.length;
int d1 = _vvvvvvvvvvvvvvvvv5;
for (int i0 = 0;i0 < d0;i0++) {
mostCurrent._vvvvvvvvvvvvvvvvv7[i0] = new anywheresoftware.b4a.objects.ButtonWrapper[d1];
for (int i1 = 0;i1 < d1;i1++) {
mostCurrent._vvvvvvvvvvvvvvvvv7[i0][i1] = new anywheresoftware.b4a.objects.ButtonWrapper();
}
}
}
;
...
int _id = 0;
String _nombrefich = "";
 //BA.debugLineNum = 218;BA.debugLine="Sub RellenarIconos";
 //BA.debugLineNum = 220;BA.debugLine="Dim fileList As List";
_filelist = new anywheresoftware.b4a.objects.collections.List();
 //BA.debugLineNum = 221;BA.debugLine="Dim i,x,y,NumFicheros,id As Int";
_i = 0;
_x = 0;
_y = 0;
_numficheros = 0;
_id = 0;
 //BA.debugLineNum = 222;BA.debugLine="Dim NombreFich As String";
_nombrefich = "";
 //BA.debugLineNum = 224;BA.debugLine="fileList = File.ListFiles(Starter.DirPictogramas)";
_filelist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._vvvvvvvvvv3._vvvv5 /*String*/ );
 //BA.debugLineNum = 225;BA.debugLine="fileList.Sort(False)";
_filelist.Sort(anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 227;BA.debugLine="NumFicheros=fileList.Size";
_numficheros = _filelist.getSize();
 //BA.debugLineNum = 228;BA.debugLine="If NumFicheros>(NumLineas*NumColumnas) Then";
if (_numficheros>(_vvvvvvvvvvvvvvvvv6*_vvvvvvvvvvvvvvvvv5)) { 
 //BA.debugLineNum = 229;BA.debugLine="NumFicheros=NumLineas*NumColumnas";
_numficheros = (int) (_vvvvvvvvvvvvvvvvv6*_vvvvvvvvvvvvvvvvv5);
 };
 //BA.debugLineNum = 232;BA.debugLine="x=0";
_x = (int) (0);
 //BA.debugLineNum = 233;BA.debugLine="y=0";
_y = (int) (0);
 //BA.debugLineNum = 234;BA.debugLine="For i=0 To NumFicheros-1";
{
final int step12 = 1;
final int limit12 = (int) (_numficheros-1);
_i = (int) (0) ;
for (;_i <= limit12 ;_i = _i + step12 ) {
 //BA.debugLineNum = 235;BA.debugLine="If y<NumLineas Then";
if (_y<_vvvvvvvvvvvvvvvvv6) { 
 //BA.debugLineNum = 236;BA.debugLine="NombreFich=fileList.Get(i)";
_nombrefich = BA.ObjectToString(_filelist.Get(_i));
 //BA.debugLineNum = 237;BA.debugLine="BotonIcono(y,x).SetBackgroundImage(LoadBitmap(S";
mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(mostCurrent._vvvvvvvvvv3._vvvv5 /*String*/ ,_nombrefich).getObject()));
 //BA.debugLineNum = 238;BA.debugLine="id=Regex.Replace(\"[^0-9]\",NombreFich,\"\")";
_id = (int)(Double.parseDouble(anywheresoftware.b4a.keywords.Common.Regex.Replace("[^0-9]",_nombrefich,"")));
 //BA.debugLineNum = 239;BA.debugLine="BotonIcono(y,x).Tag=id";
mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setTag((Object)(_id));
 //BA.debugLineNum = 240;BA.debugLine="BotonIcono(y,x).Visible=True";
mostCurrent._vvvvvvvvvvvvvvvvv7[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 241;BA.debugLine="ListadoPictogramas.Panel.Height=(y+1)*TamIcono";
mostCurrent._listadopictogramas.getPanel().setHeight((int) ((_y+1)*_vvvvvvvvvvvvvvvvv1));
 //BA.debugLineNum = 242;BA.debugLine="x=x+1";
_x = (int) (_x+1);
 //BA.debugLineNum = 243;BA.debugLine="If (x=NumColumnas) Then";
if ((_x==_vvvvvvvvvvvvvvvvv5)) { 
 //BA.debugLineNum = 244;BA.debugLine="x=0";
_x = (int) (0);
 //BA.debugLineNum = 245;BA.debugLine="y=y+1";
_y = (int) (_y+1);
 };
 };
 }
