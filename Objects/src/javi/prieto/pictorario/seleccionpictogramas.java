...
public static int _vvvvvvvvvvvvvvvvv7 = 0;
...
_web._vvvvv2("https://api.arasaac.org/api/pictograms/es/search/"+_su.EncodeUrl(parent.mostCurrent._barrabusqueda.getText(),"UTF8").replace("+","%20"));
...
group20 = _pictogramasencontrados;
index20 = 0;
...
this.state = 9;
_pictograma.setObject((anywheresoftware.b4a.objects.collections.Map.MyMap)(group20.Get(index20)));}
if (true) break;
...
//if
this.state = 20;
if (anywheresoftware.b4a.keywords.Common.File.Exists(parent.mostCurrent._vvvvvvvvvv3._vvvv5,BA.NumberToString(_id[_i])+".png")==anywheresoftware.b4a.keywords.Common.False) { 
this.state = 19;
}if (true) break;
...
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _vvvvvvvvvvvvvvvvv4(_id[_i]));
this.state = 55;
return;
case 55:
//C
...
//C
this.state = 28;
if ((step36 > 0 && _i <= limit36) || (step36 < 0 && _i >= limit36)) this.state = 23;
if (true) break;
...
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _vvvvvvvvvvvvvvvvv5(_id[_i],_url[_i]));
this.state = 58;
return;
case 58:
//C
...
this.state = 36;
step42 = 1;
limit42 = (int) (parent._vvvvvvvvvvvvvvvvv6-1);
_x = (int) (0) ;
this.state = 59;
if (true) break;
...
//C
this.state = 36;
if ((step42 > 0 && _x <= limit42) || (step42 < 0 && _x >= limit42)) this.state = 31;
if (true) break;
...
this.state = 35;
step43 = 1;
limit43 = (int) (parent._vvvvvvvvvvvvvvvvv7-1);
_y = (int) (0) ;
this.state = 61;
if (true) break;
...
//C
this.state = 35;
if ((step43 > 0 && _y <= limit43) || (step43 < 0 && _y >= limit43)) this.state = 34;
if (true) break;
...
parent.mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 if (true) break;
if (true) break;
...
//C
this.state = 48;
if ((step49 > 0 && _i <= limit49) || (step49 < 0 && _i >= limit49)) this.state = 39;
if (true) break;
...
//if
this.state = 47;
if (_y<parent._vvvvvvvvvvvvvvvvv7) { 
this.state = 42;
}if (true) break;
...
parent.mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"/pictogramas"),BA.NumberToString(_id[_i])+".png").getObject()));
 //BA.debugLineNum = 138;BA.debugLine="BotonIcono(y,x).Tag=id(i)";
parent.mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setTag((Object)(_id[_i]));
 //BA.debugLineNum = 139;BA.debugLine="BotonIcono(y,x).Visible=True";
parent.mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.True);
...
//if
this.state = 46;
if ((_x==parent._vvvvvvvvvvvvvvvvv6)) { 
this.state = 45;
}if (true) break;
...
public static void  _complete(String _urlencontrada) throws Exception{
}
public static anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvvvvvvv5(int _id,String _url) throws Exception{
...
_fichero = anywheresoftware.b4a.keywords.Common.File.OpenOutput(parent.mostCurrent._vvvvvvvvvv3._vvvv5,BA.NumberToString(_id)+".png",anywheresoftware.b4a.keywords.Common.False);
 //BA.debugLineNum = 164;BA.debugLine="File.Copy2(Web3.GetInputStream, Fichero)";
anywheresoftware.b4a.keywords.Common.File.Copy2((java.io.InputStream)(_web3._vvvvv0().getObject()),(java.io.OutputStream)(_fichero.getObject()));
...
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvvvvvvv6-1);
_x = (int) (0) ;
for (;_x <= limit2 ;_x = _x + step2 ) {
 //BA.debugLineNum = 204;BA.debugLine="For y=0 To NumLineas-1";
{
final int step3 = 1;
final int limit3 = (int) (_vvvvvvvvvvvvvvvvv7-1);
_y = (int) (0) ;
for (;_y <= limit3 ;_y = _y + step3 ) {
 //BA.debugLineNum = 205;BA.debugLine="BotonIcono(y,x).Initialize(\"BotonIcono\")";
mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].Initialize(mostCurrent.activityBA,"BotonIcono");
 //BA.debugLineNum = 206;BA.debugLine="ListadoPictogramas.Panel.AddView(BotonIcono(y,x";
mostCurrent._listadopictogramas.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].getObject()),(int) (_x*_vvvvvvvvvvvvvvvvv1),(int) (_y*_vvvvvvvvvvvvvvvvv1),_vvvvvvvvvvvvvvvvv1,_vvvvvvvvvvvvvvvvv1);
 //BA.debugLineNum = 207;BA.debugLine="BotonIcono(y,x).Visible=False";
mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 }
};
 }
};
...
public static anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvvvvvvv4(int _id) throws Exception{
ResumableSub_EncontrarURLporId rsub = new ResumableSub_EncontrarURLporId(null,_id);
rsub.resume(processBA, null);
return (anywheresoftware.b4a.keywords.Common.ResumableSubWrapper) anywheresoftware.b4a.AbsObjectWrapper.ConvertToWrapper(new anywheresoftware.b4a.keywords.Common.ResumableSubWrapper(), rsub);
}
public static class ResumableSub_EncontrarURLporId extends BA.ResumableSub {
public ResumableSub_EncontrarURLporId(javi.prieto.pictorario.seleccionpictogramas parent,int _id) {
this.parent = parent;
this._id = _id;
}
javi.prieto.pictorario.seleccionpictogramas parent;
int _id;
String _url = "";
javi.prieto.pictorario.httpjob _web2 = null;
javi.prieto.pictorario.httpjob _j2 = null;
anywheresoftware.b4a.objects.collections.JSONParser _jp = null;
...
_web2 = new javi.prieto.pictorario.httpjob();
...
_web2._vvvvv2("https://api.arasaac.org/api/pictograms/"+BA.NumberToString(_id)+"?url=true");
...
//C
this.state = 1;
_j2 = (javi.prieto.pictorario.httpjob) result[0];
;
...
_vvvvvvvvvvvvvvvvv6 = (int) (3);
 //BA.debugLineNum = 25;BA.debugLine="Dim NumLineas As Int = 20";
_vvvvvvvvvvvvvvvvv7 = (int) (20);
 //BA.debugLineNum = 28;BA.debugLine="Dim BotonIcono(NumLineas,NumColumnas) As Button";
mostCurrent._vvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.ButtonWrapper[_vvvvvvvvvvvvvvvvv7][];
{
int d0 = mostCurrent._vvvvvvvvvvvvvvvvv0.length;
int d1 = _vvvvvvvvvvvvvvvvv6;
for (int i0 = 0;i0 < d0;i0++) {
mostCurrent._vvvvvvvvvvvvvvvvv0[i0] = new anywheresoftware.b4a.objects.ButtonWrapper[d1];
for (int i1 = 0;i1 < d1;i1++) {
mostCurrent._vvvvvvvvvvvvvvvvv0[i0][i1] = new anywheresoftware.b4a.objects.ButtonWrapper();
}
}
}
;
...
public static String  _vvvvvvvvvvvvvvvvvv1() throws Exception{
...
_filelist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._vvvvvvvvvv3._vvvv5);
...
if (_numficheros>(_vvvvvvvvvvvvvvvvv7*_vvvvvvvvvvvvvvvvv6)) { 
 //BA.debugLineNum = 226;BA.debugLine="NumFicheros=NumLineas*NumColumnas";
_numficheros = (int) (_vvvvvvvvvvvvvvvvv7*_vvvvvvvvvvvvvvvvv6);
 };
...
mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(mostCurrent._vvvvvvvvvv3._vvvv5,_nombrefich).getObject()));
...
mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setTag((Object)(_id));
 //BA.debugLineNum = 237;BA.debugLine="BotonIcono(y,x).Visible=True";
mostCurrent._vvvvvvvvvvvvvvvvv0[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.True);
