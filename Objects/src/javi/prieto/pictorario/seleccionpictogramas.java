...
public anywheresoftware.b4a.objects.ButtonWrapper[][] _vvvvvvvvvvvv6 = null;
...
mostCurrent._barrabusqueda.setText(BA.ObjectToCharSequence(mostCurrent._vvvvvvvvvvv6));
 //BA.debugLineNum = 36;BA.debugLine="TamIcono=ListadoPictogramas.Width/3";
_vvvvvvvvvvv7 = (int) (mostCurrent._listadopictogramas.getWidth()/(double)3);
...
if (_tienefoco==anywheresoftware.b4a.keywords.Common.True && (mostCurrent._barrabusqueda.getText()).equals(mostCurrent._vvvvvvvvvvv6)) { 
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,(Object)(mostCurrent._vvvv1.getObject()),"PictogramaElegido",(Object)(-1));
...
anywheresoftware.b4a.keywords.Common.CallSubDelayed2(processBA,(Object)(mostCurrent._vvvv1.getObject()),"PictogramaElegido",_botonpulsado.getTag());
 //BA.debugLineNum = 52;BA.debugLine="Activity.Finish";
mostCurrent._activity.Finish();
 //BA.debugLineNum = 53;BA.debugLine="End Sub";
return "";
}
public static void  _vvvvvvvvvvvv1() throws Exception{
...
//if
this.state = 49;
if ((parent.mostCurrent._barrabusqueda.getText()).equals(parent.mostCurrent._vvvvvvvvvvv6) == false) { 
this.state = 3;
}if (true) break;
...
//if
this.state = 20;
if (anywheresoftware.b4a.keywords.Common.File.Exists(parent.mostCurrent._vvv7._vvv4,BA.NumberToString(_id[_i])+".png")==anywheresoftware.b4a.keywords.Common.False) { 
this.state = 19;
}if (true) break;
...
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _vvvvvvvvvvvv2(_id[_i]));
this.state = 55;
return;
case 55:
//C
...
anywheresoftware.b4a.keywords.Common.WaitFor("complete", processBA, this, _vvvvvvvvvvvv3(_id[_i],_url[_i]));
this.state = 58;
return;
case 58:
//C
...
this.state = 36;
step42 = 1;
limit42 = (int) (parent._vvvvvvvvvvvv4-1);
_x = (int) (0) ;
this.state = 59;
if (true) break;
...
this.state = 35;
step43 = 1;
limit43 = (int) (parent._vvvvvvvvvvvv5-1);
_y = (int) (0) ;
this.state = 61;
if (true) break;
...
parent.mostCurrent._vvvvvvvvvvvv6[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 if (true) break;
if (true) break;
...
parent.mostCurrent._vvvvvvvvvvvv6[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.Combine(anywheresoftware.b4a.keywords.Common.File.getDirInternal(),"/pictogramas"),BA.NumberToString(_id[_i])+".png").getObject()));
 //BA.debugLineNum = 135;BA.debugLine="BotonIcono(y,x).Tag=id(i)";
parent.mostCurrent._vvvvvvvvvvvv6[_y][_x].setTag((Object)(_id[_i]));
 //BA.debugLineNum = 136;BA.debugLine="BotonIcono(y,x).Visible=True";
parent.mostCurrent._vvvvvvvvvvvv6[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.True);
 //BA.debugLineNum = 137;BA.debugLine="ListadoPictogramas.Panel.Height=(y+1)*TamIcono";
parent.mostCurrent._listadopictogramas.getPanel().setHeight((int) ((_y+1)*parent._vvvvvvvvvvv7));
...
public static anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvv3(int _id,String _url) throws Exception{
...
_fichero = anywheresoftware.b4a.keywords.Common.File.OpenOutput(parent.mostCurrent._vvv7._vvv4,BA.NumberToString(_id)+".png",anywheresoftware.b4a.keywords.Common.False);
...
{
final int step2 = 1;
final int limit2 = (int) (_vvvvvvvvvvvv4-1);
_x = (int) (0) ;
for (;_x <= limit2 ;_x = _x + step2 ) {
 //BA.debugLineNum = 201;BA.debugLine="For y=0 To NumLineas-1";
{
final int step3 = 1;
final int limit3 = (int) (_vvvvvvvvvvvv5-1);
_y = (int) (0) ;
for (;_y <= limit3 ;_y = _y + step3 ) {
 //BA.debugLineNum = 202;BA.debugLine="BotonIcono(y,x).Initialize(\"BotonIcono\")";
mostCurrent._vvvvvvvvvvvv6[_y][_x].Initialize(mostCurrent.activityBA,"BotonIcono");
 //BA.debugLineNum = 203;BA.debugLine="ListadoPictogramas.Panel.AddView(BotonIcono(y,x";
mostCurrent._listadopictogramas.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvv6[_y][_x].getObject()),(int) (_x*_vvvvvvvvvvv7),(int) (_y*_vvvvvvvvvvv7),_vvvvvvvvvvv7,_vvvvvvvvvvv7);
 //BA.debugLineNum = 204;BA.debugLine="BotonIcono(y,x).Visible=False";
mostCurrent._vvvvvvvvvvvv6[_y][_x].setVisible(anywheresoftware.b4a.keywords.Common.False);
 }
};
 }
};
...
public static anywheresoftware.b4a.keywords.Common.ResumableSubWrapper  _vvvvvvvvvvvv2(int _id) throws Exception{
...
mostCurrent._vvvvvvvvvvv6 = "Buscar pictograma por texto";
 //BA.debugLineNum = 21;BA.debugLine="Dim NumColumnas As Int = 3";
_vvvvvvvvvvvv4 = (int) (3);
 //BA.debugLineNum = 22;BA.debugLine="Dim NumLineas As Int = 20";
_vvvvvvvvvvvv5 = (int) (20);
 //BA.debugLineNum = 25;BA.debugLine="Dim BotonIcono(NumLineas,NumColumnas) As Button";
mostCurrent._vvvvvvvvvvvv6 = new anywheresoftware.b4a.objects.ButtonWrapper[_vvvvvvvvvvvv5][];
{
int d0 = mostCurrent._vvvvvvvvvvvv6.length;
int d1 = _vvvvvvvvvvvv4;
for (int i0 = 0;i0 < d0;i0++) {
mostCurrent._vvvvvvvvvvvv6[i0] = new anywheresoftware.b4a.objects.ButtonWrapper[d1];
for (int i1 = 0;i1 < d1;i1++) {
mostCurrent._vvvvvvvvvvvv6[i0][i1] = new anywheresoftware.b4a.objects.ButtonWrapper();
}
}
}
;
...
_filelist = anywheresoftware.b4a.keywords.Common.File.ListFiles(mostCurrent._vvv7._vvv4);
...
if (_numficheros>(_vvvvvvvvvvvv5*_vvvvvvvvvvvv4)) { 
 //BA.debugLineNum = 223;BA.debugLine="NumFicheros=NumLineas*NumColumnas";
_numficheros = (int) (_vvvvvvvvvvvv5*_vvvvvvvvvvvv4);
 };
...
mostCurrent._vvvvvvvvvvvv6[_y][_x].SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(mostCurrent._vvv7._vvv4,_nombrefich).getObject()));
