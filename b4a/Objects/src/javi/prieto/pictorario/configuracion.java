...
public anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _vvvvvvvvvvvvvvvv4 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvv5 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvv6 = null;
public anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper _vvvvvvvvvvvvvvvv7 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvv0 = null;
...
public anywheresoftware.b4a.objects.ButtonWrapper _vvvvvvvvvvvvvvvvv2 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvvv3 = null;
public anywheresoftware.b4a.objects.LabelWrapper _vvvvvvvvvvvvvvvvv4 = null;
...
public anywheresoftware.b4a.objects.ButtonWrapper _vvvvvvvvvvvvvvvvv0 = null;
public anywheresoftware.b4a.objects.ButtonWrapper _vvvvvvvvvvvvvvvvvv1 = null;
...
mostCurrent._vvvvvvvvvv5._vvv6 /*boolean*/  = mostCurrent._vvvvvvvvvvvvvvvv4.getChecked();
...
mostCurrent._vvvvvvvvvvvvvvvv4.Initialize(mostCurrent.activityBA,"ActivarAlarmasCheck");
 //BA.debugLineNum = 41;BA.debugLine="ActivarAlarmasIcono.Initialize(\"ActivarAlarmasIco";
mostCurrent._vvvvvvvvvvvvvvvv5.Initialize(mostCurrent.activityBA,"ActivarAlarmasIcono");
 //BA.debugLineNum = 42;BA.debugLine="ActivarAlarmasLabel.Initialize(\"ActivarAlarmasLab";
mostCurrent._vvvvvvvvvvvvvvvv6.Initialize(mostCurrent.activityBA,"ActivarAlarmasLabel");
 //BA.debugLineNum = 43;BA.debugLine="ProtegerVisualizacionCheck.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvv7.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionCheck");
 //BA.debugLineNum = 44;BA.debugLine="ProtegerVisualizacionIcono.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvv0.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionIcono");
 //BA.debugLineNum = 45;BA.debugLine="ProtegerVisualizacionLabel.Initialize(\"ProtegerVi";
mostCurrent._vvvvvvvvvvvvvvvvv1.Initialize(mostCurrent.activityBA,"ProtegerVisualizacionLabel");
 //BA.debugLineNum = 46;BA.debugLine="FormatoHorasButton.Initialize(\"FormatoHorasButton";
mostCurrent._vvvvvvvvvvvvvvvvv2.Initialize(mostCurrent.activityBA,"FormatoHorasButton");
 //BA.debugLineNum = 47;BA.debugLine="FormatoHorasLabel.Initialize(\"FormatoHorasLabel\")";
mostCurrent._vvvvvvvvvvvvvvvvv3.Initialize(mostCurrent.activityBA,"FormatoHorasLabel");
 //BA.debugLineNum = 48;BA.debugLine="ColoresRelojLabel.Initialize(\"ColoresRelojLabel\")";
mostCurrent._vvvvvvvvvvvvvvvvv4.Initialize(mostCurrent.activityBA,"ColoresRelojLabel");
 //BA.debugLineNum = 49;BA.debugLine="BotonHoras.Initialize(\"BotonHoras\")";
mostCurrent._vvvvvvvvvvvvvvvvv5.Initialize(mostCurrent.activityBA,"BotonHoras");
 //BA.debugLineNum = 50;BA.debugLine="BotonMinutos.Initialize(\"BotonMinutos\")";
mostCurrent._vvvvvvvvvvvvvvvvv6.Initialize(mostCurrent.activityBA,"BotonMinutos");
 //BA.debugLineNum = 51;BA.debugLine="BotonSegundos.Initialize(\"BotonSegundos\")";
mostCurrent._vvvvvvvvvvvvvvvvv7.Initialize(mostCurrent.activityBA,"BotonSegundos");
 //BA.debugLineNum = 52;BA.debugLine="BotonReiniciar.Initialize(\"BotonReiniciar\")";
mostCurrent._vvvvvvvvvvvvvvvvv0.Initialize(mostCurrent.activityBA,"BotonReiniciar");
 //BA.debugLineNum = 53;BA.debugLine="BotonVolver.Initialize(\"BotonVolver\")";
mostCurrent._vvvvvvvvvvvvvvvvvv1.Initialize(mostCurrent.activityBA,"BotonVolver");
 //BA.debugLineNum = 55;BA.debugLine="ActivarAlarmasLabel.Text=\"Activar alarmas\"";
mostCurrent._vvvvvvvvvvvvvvvv6.setText(BA.ObjectToCharSequence("Activar alarmas"));
 //BA.debugLineNum = 56;BA.debugLine="ActivarAlarmasLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvv6.setTextSize((float) (16));
 //BA.debugLineNum = 57;BA.debugLine="ActivarAlarmasLabel.Gravity=Gravity.CENTER_VERTIC";
mostCurrent._vvvvvvvvvvvvvvvv6.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 59;BA.debugLine="ProtegerVisualizacionLabel.Text=\"Proteger aplicac";
mostCurrent._vvvvvvvvvvvvvvvvv1.setText(BA.ObjectToCharSequence("Proteger aplicación"));
...
mostCurrent._vvvvvvvvvvvvvvvvv3.setText(BA.ObjectToCharSequence("Formato horario"));
 //BA.debugLineNum = 64;BA.debugLine="FormatoHorasLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvvv3.setTextSize((float) (16));
 //BA.debugLineNum = 65;BA.debugLine="FormatoHorasLabel.Gravity=Gravity.CENTER_VERTICAL";
mostCurrent._vvvvvvvvvvvvvvvvv3.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 67;BA.debugLine="ActivarAlarmasCheck.Checked=Starter.AlarmasActiva";
mostCurrent._vvvvvvvvvvvvvvvv4.setChecked(mostCurrent._vvvvvvvvvv5._vvv6 /*boolean*/ );
 //BA.debugLineNum = 68;BA.debugLine="ActivarAlarmasCheck.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvv4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 70;BA.debugLine="ProtegerVisualizacionCheck.Checked=Starter.Aplica";
mostCurrent._vvvvvvvvvvvvvvvv7.setChecked(mostCurrent._vvvvvvvvvv5._vvv7 /*boolean*/ );
 //BA.debugLineNum = 71;BA.debugLine="ProtegerVisualizacionCheck.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvv7.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 73;BA.debugLine="ColoresRelojLabel.Text=\"Colores del reloj (horari";
mostCurrent._vvvvvvvvvvvvvvvvv4.setText(BA.ObjectToCharSequence("Colores del reloj (horario, minutero y segundero)"));
 //BA.debugLineNum = 74;BA.debugLine="ColoresRelojLabel.TextSize=16";
mostCurrent._vvvvvvvvvvvvvvvvv4.setTextSize((float) (16));
 //BA.debugLineNum = 75;BA.debugLine="ColoresRelojLabel.Gravity=Gravity.CENTER_VERTICAL";
mostCurrent._vvvvvvvvvvvvvvvvv4.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER_VERTICAL);
 //BA.debugLineNum = 77;BA.debugLine="BotonHoras.Color=Starter.ColorHoras";
mostCurrent._vvvvvvvvvvvvvvvvv5.setColor(mostCurrent._vvvvvvvvvv5._vvvv1 /*int*/ );
 //BA.debugLineNum = 78;BA.debugLine="BotonMinutos.Color=Starter.ColorMinutos";
mostCurrent._vvvvvvvvvvvvvvvvv6.setColor(mostCurrent._vvvvvvvvvv5._vvvv2 /*int*/ );
 //BA.debugLineNum = 79;BA.debugLine="BotonSegundos.Color=Starter.ColorSegundos";
mostCurrent._vvvvvvvvvvvvvvvvv7.setColor(mostCurrent._vvvvvvvvvv5._vvvv3 /*int*/ );
...
mostCurrent._vvvvvvvvvvvvvvvvv2.setText(BA.ObjectToCharSequence("24 horas"));
 }else {
 //BA.debugLineNum = 84;BA.debugLine="FormatoHorasButton.Text=\"12 horas\"";
mostCurrent._vvvvvvvvvvvvvvvvv2.setText(BA.ObjectToCharSequence("12 horas"));
 };
 //BA.debugLineNum = 86;BA.debugLine="FormatoHorasButton.TextSize=20";
mostCurrent._vvvvvvvvvvvvvvvvv2.setTextSize((float) (20));
 //BA.debugLineNum = 87;BA.debugLine="FormatoHorasButton.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvv2.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 89;BA.debugLine="BotonReiniciar.Text=\"Reiniciar configuración\"";
mostCurrent._vvvvvvvvvvvvvvvvv0.setText(BA.ObjectToCharSequence("Reiniciar configuración"));
 //BA.debugLineNum = 90;BA.debugLine="BotonReiniciar.TextSize=20";
mostCurrent._vvvvvvvvvvvvvvvvv0.setTextSize((float) (20));
 //BA.debugLineNum = 91;BA.debugLine="BotonReiniciar.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvv0.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 93;BA.debugLine="BotonVolver.Text=\"Volver a la portada\"";
mostCurrent._vvvvvvvvvvvvvvvvvv1.setText(BA.ObjectToCharSequence("Volver a la portada"));
 //BA.debugLineNum = 94;BA.debugLine="BotonVolver.TextSize=20";
mostCurrent._vvvvvvvvvvvvvvvvvv1.setTextSize((float) (20));
 //BA.debugLineNum = 95;BA.debugLine="BotonVolver.Gravity=Gravity.CENTER";
mostCurrent._vvvvvvvvvvvvvvvvvv1.setGravity(anywheresoftware.b4a.keywords.Common.Gravity.CENTER);
 //BA.debugLineNum = 97;BA.debugLine="ActivarAlarmasIcono.SetBackgroundImage(LoadBitmap";
mostCurrent._vvvvvvvvvvvvvvvv5.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"alarma.png").getObject()));
 //BA.debugLineNum = 98;BA.debugLine="ProtegerVisualizacionIcono.SetBackgroundImage(Loa";
mostCurrent._vvvvvvvvvvvvvvvv0.SetBackgroundImageNew((android.graphics.Bitmap)(anywheresoftware.b4a.keywords.Common.LoadBitmap(anywheresoftware.b4a.keywords.Common.File.getDirAssets(),"llave.png").getObject()));
 //BA.debugLineNum = 100;BA.debugLine="PanelScroll.Panel.AddView(ActivarAlarmasLabel,10d";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvv6.getObject()),anywheresoftware.b4a.keywords.Common.DipToCurrent((int) (10)),(int) (0),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_altura-4*_separador),_altura);
 //BA.debugLineNum = 101;BA.debugLine="PanelScroll.Panel.AddView(ActivarAlarmasIcono,Act";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvv5.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvv6.getLeft()+mostCurrent._vvvvvvvvvvvvvvvv6.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvv6.getTop(),_altura,_altura);
 //BA.debugLineNum = 102;BA.debugLine="PanelScroll.Panel.AddView(ActivarAlarmasCheck,Act";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvv4.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvv5.getLeft()+mostCurrent._vvvvvvvvvvvvvvvv5.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvv5.getTop(),_altura,_altura);
 //BA.debugLineNum = 104;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionLa";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv1.getObject()),mostCurrent._vvvvvvvvvvvvvvvv6.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvv6.getTop()+mostCurrent._vvvvvvvvvvvvvvvv6.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvv6.getWidth(),mostCurrent._vvvvvvvvvvvvvvvv6.getHeight());
 //BA.debugLineNum = 105;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionIc";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvv0.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvv1.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvv1.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv1.getTop(),_altura,_altura);
 //BA.debugLineNum = 106;BA.debugLine="PanelScroll.Panel.AddView(ProtegerVisualizacionCh";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvv7.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvv0.getLeft()+mostCurrent._vvvvvvvvvvvvvvvv0.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv1.getTop(),_altura,mostCurrent._vvvvvvvvvvvvvvvvv1.getHeight());
 //BA.debugLineNum = 108;BA.debugLine="PanelScroll.Panel.AddView(FormatoHorasLabel,Prote";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv3.getObject()),mostCurrent._vvvvvvvvvvvvvvvvv1.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvvv1.getTop()+mostCurrent._vvvvvvvvvvvvvvvvv1.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv1.getWidth(),mostCurrent._vvvvvvvvvvvvvvvvv1.getHeight());
 //BA.debugLineNum = 109;BA.debugLine="PanelScroll.Panel.AddView(FormatoHorasButton,Prot";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv2.getObject()),mostCurrent._vvvvvvvvvvvvvvvv0.getLeft(),mostCurrent._vvvvvvvvvvvvvvvvv3.getTop(),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._vvvvvvvvvvvvvvvv0.getLeft()-_separador),mostCurrent._vvvvvvvvvvvvvvvvv3.getHeight());
 //BA.debugLineNum = 111;BA.debugLine="PanelScroll.Panel.AddView(ColoresRelojLabel,Forma";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv4.getObject()),mostCurrent._vvvvvvvvvvvvvvvvv3.getLeft(),(int) (mostCurrent._vvvvvvvvvvvvvvvvv3.getTop()+mostCurrent._vvvvvvvvvvvvvvvvv3.getHeight()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv3.getWidth(),mostCurrent._vvvvvvvvvvvvvvvvv3.getHeight());
 //BA.debugLineNum = 113;BA.debugLine="Dim TamBotonesColores=(100%X-ColoresRelojLabel.Le";
_tambotonescolores = (int) ((anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-mostCurrent._vvvvvvvvvvvvvvvvv4.getLeft()-mostCurrent._vvvvvvvvvvvvvvvvv4.getWidth()-4*_separador)/(double)3);
 //BA.debugLineNum = 114;BA.debugLine="PanelScroll.Panel.AddView(BotonHoras,ColoresReloj";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv5.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvv4.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvv4.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv4.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 115;BA.debugLine="PanelScroll.Panel.AddView(BotonMinutos,BotonHoras";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv6.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvv5.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvv5.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv4.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 116;BA.debugLine="PanelScroll.Panel.AddView(BotonSegundos,BotonMinu";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv7.getObject()),(int) (mostCurrent._vvvvvvvvvvvvvvvvv6.getLeft()+mostCurrent._vvvvvvvvvvvvvvvvv6.getWidth()+_separador),mostCurrent._vvvvvvvvvvvvvvvvv4.getTop(),_tambotonescolores,_tambotonescolores);
 //BA.debugLineNum = 118;BA.debugLine="PanelScroll.Panel.AddView(BotonReiniciar,Separado";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvv0.getObject()),_separador,(int) (mostCurrent._vvvvvvvvvvvvvvvvv4.getTop()+mostCurrent._vvvvvvvvvvvvvvvvv4.getHeight()+_separador),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_separador),_altura);
 //BA.debugLineNum = 120;BA.debugLine="PanelScroll.Panel.AddView(BotonVolver,Separador,B";
mostCurrent._panelscroll.getPanel().AddView((android.view.View)(mostCurrent._vvvvvvvvvvvvvvvvvv1.getObject()),_separador,(int) (mostCurrent._vvvvvvvvvvvvvvvvv0.getTop()+mostCurrent._vvvvvvvvvvvvvvvvv0.getHeight()+_separador),(int) (anywheresoftware.b4a.keywords.Common.PerXToCurrent((float) (100),mostCurrent.activityBA)-2*_separador),_altura);
 //BA.debugLineNum = 122;BA.debugLine="PanelScroll.Panel.Height=BotonVolver.Top+BotonVol";
mostCurrent._panelscroll.getPanel().setHeight((int) (mostCurrent._vvvvvvvvvvvvvvvvvv1.getTop()+mostCurrent._vvvvvvvvvvvvvvvvvv1.getHeight()+_separador));
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv5._vvvv1 /*int*/ );
...
mostCurrent._vvvvvvvvvv5._vvvv1 /*int*/  = _dialogocolor.getRGB();
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv5._vvvv2 /*int*/ );
...
mostCurrent._vvvvvvvvvv5._vvvv2 /*int*/  = _dialogocolor.getRGB();
 //BA.debugLineNum = 169;BA.debugLine="BotonMinutos.Color=DialogoColor.RGB";
mostCurrent._vvvvvvvvvvvvvvvvv6.setColor(_dialogocolor.getRGB());
...
_dialogocolor.setRGB(mostCurrent._vvvvvvvvvv5._vvvv3 /*int*/ );
...
mostCurrent._vvvvvvvvvv5._vvvv3 /*int*/  = _dialogocolor.getRGB();
 //BA.debugLineNum = 182;BA.debugLine="BotonSegundos.Color=DialogoColor.RGB";
mostCurrent._vvvvvvvvvvvvvvvvv7.setColor(_dialogocolor.getRGB());
...
mostCurrent._vvvvvvvvvv5._vvv0 /*boolean*/  = anywheresoftware.b4a.keywords.Common.Not(mostCurrent._vvvvvvvvvv5._vvv0 /*boolean*/ );
...
mostCurrent._vvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 18;BA.debugLine="Private ActivarAlarmasIcono As Label";
mostCurrent._vvvvvvvvvvvvvvvv5 = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvv7 = new anywheresoftware.b4a.objects.CompoundButtonWrapper.CheckBoxWrapper();
 //BA.debugLineNum = 21;BA.debugLine="Private ProtegerVisualizacionIcono As Label";
mostCurrent._vvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvvv2 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 25;BA.debugLine="Private FormatoHorasLabel As Label";
mostCurrent._vvvvvvvvvvvvvvvvv3 = new anywheresoftware.b4a.objects.LabelWrapper();
 //BA.debugLineNum = 26;BA.debugLine="Private ColoresRelojLabel As Label";
mostCurrent._vvvvvvvvvvvvvvvvv4 = new anywheresoftware.b4a.objects.LabelWrapper();
...
mostCurrent._vvvvvvvvvvvvvvvvv0 = new anywheresoftware.b4a.objects.ButtonWrapper();
 //BA.debugLineNum = 31;BA.debugLine="Private BotonVolver As Button";
mostCurrent._vvvvvvvvvvvvvvvvvv1 = new anywheresoftware.b4a.objects.ButtonWrapper();
...
mostCurrent._vvvvvvvvvv5._vvv7 /*boolean*/  = mostCurrent._vvvvvvvvvvvvvvvv7.getChecked();
